            ...
            with model as temp_model, universal as temp_universal:
                ...
                if dont_continue == 0:
                    ...
                    if dont_continue == 0:
                        ...
                        report_dict['whole_path_like'] = avg_like
...
#                     sys.stdout.write('Run time: ' + str(elapsed/60) + " [mins]...")
                ...
                if dont_continue == 1:
                    ...
                    report_dict['Nitrogen'] = nitrogen
                    report_dict['objective'] = product_name
                    report_dict['opt_before'] = 0.0
                    report_dict['opt_after'] = 0.0
                    report_dict['whole_path_like'] = 0.0
                    report_dict['gap_avg_like'] = 0.0
                    report_dict['path_avg_like'] = 0.0
                    report_dict['gaps_filled'] = "Gapfill Failed"
                    report_dict['mets_added'] = "Gapfill Failed"
                    report_dict['reactions_w_flux'] = "Gapfill Failed"
                    report_dict['gaps_w_flux'] = "Gapfill Failed"
                    report_dict['path_w_flux'] = "Gapfill Failed"
                    report_dict['active_rxns'] = "Gapfill Failed"
                    report_dict['demands'] = "Gapfill Failed"
